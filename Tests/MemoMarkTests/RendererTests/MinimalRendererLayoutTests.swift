...
struct MinimalRendererLayoutTests {
    ...
    @Test("Minimal projects the user's slot A composition before the smart result")
    func projectsUsersSlotACompositionBeforeSmartResult() {
    ...
    @Test("Minimal does not borrow Classic White slot D when slot A is empty")
    func doesNotBorrowClassicWhiteSlotDWhenSlotAIsEmpty() {
        var template = Template.classicWhite
