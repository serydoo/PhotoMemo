...
struct ConfigurationMigrationTests {
    ...
    func legacyTemplatePresetsMigrateThroughSavedConfigurationLoading(
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.legacyPreset.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentPersistsTemplateBadgePhotoDescriptionAndEditorState() async throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.save.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentKeepsAutomaticAlbumOutputNormalizedAndPreservesClearedPhotoDescriptionState() async throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.normalization.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentPreservesSavedLocationDisplayWhenRequestHasNoLocationUpdate() async throws {
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.preserveLocationDisplay.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func configurationCoordinatorSaveV1ConfigurationUpdatesExistingBirthdayAnchorInPlaceAndResetsCountdownSemantics() throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.anchor.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func configurationCoordinatorSaveV1ConfigurationRefreshesLiveRuntimeSnapshotsImmediately() throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.liveSnapshot.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentPersistsSubjectAvatarLogoIntoTheDefaultOutputSnapshot() async throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.subjectAvatar.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentCanPreserveExistingSubjectLibraryWhenRequested() async throws {
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.preserveSubjectLibrary.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func saveV1ConfigurationIntentKeepsSelectedSubjectInStaleSubjectLibrarySaves() async throws {
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.staleSubjectLibrarySave.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func aggregateSaveProjectsLegacySettingsAfterDurableReceipt() async throws {
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.aggregateProjection.\(UUID().uuidString)"
    ...
    func aggregateValidationFailureSkipsRefreshAndCallback() async throws {
        ...
        do {
            ...
            Issue.record("Expected MemoMarkError, got \(error)")
        }
...
private extension ConfigurationMigrationTests {
    ...
    static func makeDefaults(
        ...
        let suiteName =
            "MemoMark.ConfigurationMigrationTests.\(suffix).\(UUID().uuidString)"
        let defaults = try #require(
            UserDefaults(suiteName: suiteName)
        )
        defaults.removePersistentDomain(forName: suiteName)
