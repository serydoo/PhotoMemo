...
struct MemoryResultContractTests {
    ...
    func configurationSessionProjectsMemoryResultThroughPresentationAdapter() throws {
        let source =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/ConfigurationCenter/ConfigurationSession.swift"
            )
    ...
    func previewResolverProjectsMemoryResultThroughPresentationAdapter() throws {
        let source =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/MemoryEngine/MemoryExpressionPreviewResolver.swift"
            )
    ...
    func memoryExpressionEngineExposesMemoryResultAsItsOutputBoundary() throws {
        let source =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/MemoryEngine/MemoryExpressionEngine.swift"
            )
    ...
    func productionResolverIsolatesLiveDefaultsBehindLegacyFallback() throws {
        let source =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/MemoryEngine/ProductionMemoryResolver.swift"
            )
    ...
    func productionSourceDoesNotWriteLegacyPairedFrozenSubject() throws {
        let providerSource =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/App/BatchConfigurationSnapshotProvider.swift"
            )
        let batchProcessingSource =
            try sourceText(
                relativePath:
                    "Source/MemoMark/MemoMark/Models/BatchProcessing.swift"
            )
    ...
    func productionPathsConsumeCanonicalProductionSnapshotProjection() throws {
        let productionFiles = [
            "Source/MemoMark/MemoMark/MemoryEngine/ProductionMemoryResolver.swift",
            "Source/MemoMark/MemoMark/Services/RecordCardBuildService.swift",
            "Source/MemoMark/MemoMark/App/MemoMarkShareWorkflowSummary.swift",
        ]
