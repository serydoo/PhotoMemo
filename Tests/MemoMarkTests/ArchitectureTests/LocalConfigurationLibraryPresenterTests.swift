...
struct LocalConfigurationLibraryPresenterTests {
    ...
    func rowsFilterByCurrentSubject() {
        ...
        let rows = LocalConfigurationLibraryPresenter.rows(
    ...
    func subjectOnlySaveKeepsLatestAvatarAndConfigurations() throws {
        ...
        let assetRootURL = MemoMarkSharedContainer
            .baseDirectoryURL
    ...
    func backupReceiptReportsRevisionConflict() {
        ...
        let feedback = LocalConfigurationLibraryPresenter
...
private extension LocalConfigurationLibraryPresenterTests {
