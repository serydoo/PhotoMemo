...
struct HomeRecentProcessingPresenterTests {
    ...
    func homeActivityProjectionFormatsEveryInterfaceLanguage() throws {
        ...
        let projection = try #require(
            HomeActivityPresenter.projection(from: snapshot)
        )
    ...
    func homeRecentProcessingChromeFollowsTheInterfaceLanguage() {
        ...
        let presentation = HomeRecentProcessingPresenter.presentation(
            header: header,
            snapshot: nil,
            recoveryMessage: nil,
            language: .japanese
