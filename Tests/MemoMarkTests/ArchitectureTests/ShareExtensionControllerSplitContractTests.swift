...
struct ShareExtensionControllerSplitContractTests {
    ...
    func shareExtensionUsesCompactAppleNativeHandoffLanguage() throws {
        ...
        #expect(controller.contains("currentStyleValueLabel.text =\n                configurationTitle"))
        ...
        #expect(controller.contains("stack.spacing = 16"))
        #expect(controller.contains("MemoMarkDesignTokens.Layout.brandLineSpacing"))
    ...
    func shareExtensionOwnsFocusedLifecycleCollaborators() throws {
        ...
        let handoff = try sourceText(
            "Source/MemoMark/MemoMark/iOS/ShareExtension/ShareExtensionHandoffCoordinator.swift"
        )
        let progress = try sourceText(
            "Source/MemoMark/MemoMark/iOS/ShareExtension/ShareExtensionProgressObserver.swift"
        )
