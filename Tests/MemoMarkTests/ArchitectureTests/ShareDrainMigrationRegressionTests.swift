...
struct ShareDrainMigrationRegressionTests {
    ...
    func submitExternalURLsIntentRefreshesConfigurationAndFiltersInputs() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.Submit.\(UUID().uuidString)"
        )
    ...
    func queuePersistenceFailureKeepsShareRequestPending() async throws {
        ...
        let runtime = MemoMarkAppRuntime(environment: environment)
    ...
    func directPreparationDoesNotStartProcessingThroughRevision() async throws {
        let suiteName =
            "MemoMark.ShareDrainMigrationRegressionTests.Preparation.\(UUID().uuidString)"
    ...
    func corruptShareMetadataSuppressesManagedOrphanCleanup() async throws {
        ...
        let runtime = MemoMarkAppRuntime(
    ...
    func queueCoordinatorEnqueuesDrainedShareRequestsWithoutChangingSemantics() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.Enqueue.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
    ...
    func processShareIntentEnqueuesDrainedRequestWithoutChangingSemantics() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.ProcessIntent.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
    ...
    func acknowledgementRetryReusesDurableShareJob() async throws {
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.IdempotentAdmission.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
        let sourceURL =
            try SyntheticFixtureLibrary.fixtureURL(
    ...
    func processShareIntentKeepsValidLivePhotoBundleDirectories() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.LivePhotoBundle.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
    ...
    func processShareIntentRecoversUniqueLivePhotoAssetIdentityFromStaticFallback() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.LivePhotoRecovery.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
    ...
    func processShareIntentPreservesLivePhotoTypeWhenRecoveryIsAmbiguous() async throws {
        ...
        let context = try Self.makeContext(
            named:
                "MemoMark.ShareDrainMigrationRegressionTests.LivePhotoAmbiguous.\(UUID().uuidString)"
        )
        defer { Self.cleanup(context) }
