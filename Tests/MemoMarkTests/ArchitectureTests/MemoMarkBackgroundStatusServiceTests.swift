...
struct MemoMarkBackgroundStatusServiceTests {
    ...
    func currentSnapshotCountsOnlyUnfinishedSubsequentExternalJobs() throws {
        let suiteName =
            "MemoMark.BackgroundStatusServiceTests.queue.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func latestCompletedExternalJobIsNotMaskedByOlderRetryableFailures() throws {
        ...
        let suiteName =
            "MemoMark.BackgroundStatusServiceTests.latest.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func recentExternalJobSummariesKeepLatestTenJobs() throws {
        ...
        let suiteName =
            "MemoMark.BackgroundStatusServiceTests.recent.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
        ...
        #expect(service.hasProcessingRecord)
    ...
    func terminalIntakeFailureExposesConcreteReason() throws {
        let suiteName =
            "MemoMark.BackgroundStatusServiceTests.failure.\(UUID().uuidString)"
