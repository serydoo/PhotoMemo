...
struct CrossTargetLocalizationTests {
    ...
    private let shareSurfaceFiles = [
        ...
        "Source/MemoMark/MemoMark/iOS/ShareExtension/ShareExtensionPreviewController.swift"
    ]

    private let widgetSurfaceFiles = [
        "Source/MemoMark/MemoMark/iOS/Activity/MemoMarkLiveActivityPresentation.swift"
    ]

    private let macOSSurfaceFiles = [
        "Source/MemoMark/MemoMark/ConfigurationCenter/ConfigurationCenterView.swift",
        "Source/MemoMark/MemoMark/ConfigurationCenter/Sidebar/MemorySubjectListView.swift",
        "Source/MemoMark/MemoMark/ConfigurationCenter/MemoryCard/InteractiveMemoryCardConfigurationContext.swift",
        "Source/MemoMark/MemoMark/ConfigurationCenter/Inspector/InspectorView.swift",
        "Source/MemoMark/MemoMark/ConfigurationCenter/Inspector/MemoryBlockInspectorConfigurationPickerSection.swift",
