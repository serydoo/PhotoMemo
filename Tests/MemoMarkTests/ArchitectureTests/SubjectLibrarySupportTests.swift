...
struct V1SubjectLibrarySupportTests {
    ...
    func addDefaultSubjectAppendsAndSelects() throws {
        ...
        let insertedSubject = SubjectLibraryMutationCoordinator
            .addDefaultSubject(
    ...
    func subjectSwitchPersistencePreservesMemoryPresets() async throws {
        let suiteName =
            "MemoMark.V1SubjectLibrarySupportTests.presetPreserve.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func addSubjectAfterCorruptBootstrapPreservesRawPayload() async throws {
        let suiteName =
            "MemoMark.V1SubjectLibrarySupportTests.corruptAdd.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func explicitCorruptLibraryRecoveryPreservesRawPayloadAndSavesLibrary() async throws {
        let suiteName =
            "MemoMark.V1SubjectLibrarySupportTests.corruptRecover.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
        ...
        let recovery =
            try #require(
                SubjectLibraryRecoveryCoordinator
    ...
    func deletingSelectedPresetPersistsUpdatedSubjectLibraryImmediately() throws {
        let suiteName =
            "MemoMark.V1SubjectLibrarySupportTests.deletePreset.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func editorFlowCallbackEmitsSyncPatchAfterSaving() async throws {
        ...
        var emittedPatch: SubjectFlowPatch?
