...
struct PhotoMetadataReaderTests {
    ...
    @Test("Parses dates consistently during concurrent metadata reads")
    func parsesDatesConsistentlyDuringConcurrentMetadataReads() async {
        ...
        #expect(values.allSatisfy { $0 == 8 * 3600 })
    }
