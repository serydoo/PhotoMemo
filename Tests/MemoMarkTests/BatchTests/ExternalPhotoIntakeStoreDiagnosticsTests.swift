...
struct ExternalPhotoIntakeStoreDiagnosticsTests {
    ...
    func detailedDrainSurfacesClearPersistenceFailures() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.Drain.\(UUID().uuidString)"
    ...
    func distinguishesMissingPersistedRequestsFromCorruptedPayloads() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.Persistence.\(UUID().uuidString)"
    ...
    func reportsCopyStageFailureForNonFileURLs() {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.\(UUID().uuidString)"
    ...
    func createsManagedCopyForReadableLocalFiles() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.LocalFile.\(UUID().uuidString)"
    ...
    func rejectsFilesThatExistButAreNotReadableImages() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.InvalidImage.\(UUID().uuidString)"
    ...
    func preservesOriginalManagedCopyFileNameAndCopySuffixes() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.CopySuffix.\(UUID().uuidString)"
    ...
    func prefersOriginalSharedFileNameOverTemporaryProviderFileName() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.PreferredOriginalName.\(UUID().uuidString)"
    ...
    func persistedIntakeRequestsRetainStructuredItemProvenance() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.PersistItems.\(UUID().uuidString)"
    ...
    func persistingManagedRequestsRecordsSharedContainerReadinessDiagnostics() throws {
        ...
        let suiteName =
            "MemoMark.ExternalPhotoIntakeStoreDiagnosticsTests.Readiness.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
