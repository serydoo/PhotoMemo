...
struct BatchConfigurationSnapshotProviderDiagnosticsTests {
    ...
    func legacyV1SnapshotKeepsConfigurationIdentityNil() throws {
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.legacyIdentity.\(UUID().uuidString)"
    ...
    func corruptedTemplatePayloadIsSurfacedAsDecodingFailure() throws {
        ...
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.corruptedTemplate.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func missingSharedDefaultsPayloadsRemainDistinguishableFromDecodingFailures() throws {
        ...
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.noValue.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func defaultAndSharedSnapshotLoadingKeepRawAnchorExpressionStylePayloadsThroughRoundTripReEncoding() throws {
        ...
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.expressionStyle.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func loadedBatchSnapshotEmbedsMemorySubjectInFrozenConfigurationSnapshot() throws {
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.frozenMemory.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func loadedBatchSnapshotPrefersSavedMemorySubjectOverLegacyPersonalProfile() throws {
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.selectedMemorySubject.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func loadedBatchSnapshotPrefersSelectedSubjectLibraryRecordOverStaleStandaloneSubjectAndDefaultProfile() throws {
        let suiteName =
            "MemoMark.BatchConfigurationSnapshotProviderDiagnosticsTests.subjectLibraryFallback.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
