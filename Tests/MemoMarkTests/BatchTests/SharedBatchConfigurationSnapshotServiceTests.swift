...
struct SharedBatchConfigurationSnapshotServiceTests {
    ...
    func typedTemplateReadsSurfaceDecodingFailures() throws {
        ...
        let suiteName =
            "MemoMark.SharedBatchConfigurationSnapshotServiceTests.template.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func sharedSnapshotCarriesLocationDisplayConfiguration() throws {
        ...
        let suiteName =
            "MemoMark.SharedBatchConfigurationSnapshotServiceTests.locationDisplay.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func configurationReadinessRequiresSavedPreset() throws {
        let suiteName =
            "MemoMark.SharedBatchConfigurationSnapshotServiceTests.readiness.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
