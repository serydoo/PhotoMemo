...
@Suite("MemoMark share diagnostics")
struct MemoMarkShareDiagnosticsTests {

    @Test("Reset result surfaces encoding failures")
    func resetResultSurfacesEncodingFailures() throws {

        let suiteName =
            "MemoMark.ShareDiagnostics.Reset.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func distinguishesEmptyStorageFromCorruptedPayloads() throws {
        ...
        let suiteName =
            "MemoMark.ShareDiagnostics.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func retainsFullTwentyPhotoMixedEvidenceMatrix() throws {
        ...
        let suiteName =
            "MemoMark.ShareDiagnostics.Retention.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
    ...
    func persistResultSurfacesEncodingFailures() throws {
        ...
        let suiteName =
            "MemoMark.ShareDiagnostics.Persist.\(UUID().uuidString)"
        let defaults =
            try #require(
                UserDefaults(
                    suiteName: suiteName
