...
struct LocalizationResourceParityTests {
            ...
            let bundle = Bundle(
                path: repositoryRoot
                    .appendingPathComponent(
                        "Source/PhotoMemo/PhotoMemo/\(code).lproj"
                    )
                    .path
            )
    ...
    func coreTerminologyIsNotAnEnglishFallback() throws {
        let japanese = parseResource(
            try sourceText(
                "Source/PhotoMemo/PhotoMemo/ja.lproj/Localizable.strings"
            )
        )
        let korean = parseResource(
            try sourceText(
                "Source/PhotoMemo/PhotoMemo/ko.lproj/Localizable.strings"
            )
        )
    ...
    func xcodeVariantGroupContainsNewLanguages() throws {
        ...
        #expect(
            project.contains(
                "PhotoMemo/ja.lproj/Localizable.strings"
            )
        )
        #expect(
            project.contains(
                "PhotoMemo/ko.lproj/Localizable.strings"
            )
        )
        #expect(
