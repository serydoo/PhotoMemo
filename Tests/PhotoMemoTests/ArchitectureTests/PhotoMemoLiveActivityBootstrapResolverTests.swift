...
struct PhotoMemoLiveActivityBootstrapResolverTests {
    ...
    func duplicateJobActivitiesRetainOneActivityAndReturnTheRemainderForCleanup() {
        ...
        let result =
            PhotoMemoLiveActivityBootstrapResolver.resolve(
                candidates: [
    ...
    func queueReconciliationEndsTrackedJobsThatAreNoLongerCurrent() {
        ...
        #expect(
            PhotoMemoLiveActivityQueueReconciliationResolver.jobIDsToEnd(
    ...
    func requestFailurePolicyScopesSuppression() {
        #expect(
            PhotoMemoLiveActivityRequestFailurePolicy.disposition(
    ...
    func transientTerminalFailureRemainsScheduledUntilRetry() {
        let jobID = UUID()
        var registry =
            PhotoMemoLiveActivityRequestRetryRegistry<String>()
