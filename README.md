...
PhotoMemo 是一款面向家庭记录场景的 macOS 原生照片信息纪念卡生成器。

它的目标不是修图、滤镜或云相册，而是让每一张照片都能带上时间、设备、拍摄信息，以及和人生节点有关的记忆语义。

## 项目定位

**PhotoMemo = 一款完全本地优先运行、基于 EXIF 和时间锚点生成高品质照片信息卡的 SwiftUI macOS 应用。**
...
PhotoMemo 现在已经不是单纯的“给照片加边框”工具，而是两层结构：
...
也就是说，主界面不是未来的“批量作业台”，而是**规则配置器 + 预览器**。
