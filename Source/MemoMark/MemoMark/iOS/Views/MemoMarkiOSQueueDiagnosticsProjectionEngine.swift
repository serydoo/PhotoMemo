...
enum MemoMarkiOSQueueDiagnosticsTint:
    Hashable {
...
#if canImport(SwiftUI)
extension MemoMarkiOSQueueDiagnosticsTint {
...
struct MemoMarkiOSQueueDiagnosticsHeaderProjection:
    Hashable {
...
struct MemoMarkiOSQueuePipelineStepProjection:
    Hashable {
...
struct MemoMarkiOSQueueProgressProjection:
    Hashable {
    ...
    let pipelineSteps:
        [MemoMarkiOSQueuePipelineStepProjection]
}

struct MemoMarkiOSQueueDiagnosticEventProjection:
    Identifiable,
    Hashable {
...
enum MemoMarkiOSQueueDiagnosticsProjectionEngine {
    ...
    static func headerProjection(
        ...
        if let backgroundSnapshot,
           !shouldPrioritizeLatestShareDiagnostic(
            ...
            return MemoMarkiOSQueueDiagnosticsHeaderProjection(
                headline:
    ...
    static func progressProjection(
    ...
    ) -> MemoMarkiOSQueueProgressProjection {
        ...
        return MemoMarkiOSQueueProgressProjection(
            title:
                progressTitle(
                    snapshot,
                    language: language
    ...
    static func eventDisplayProjections(
        ...
        language:
            MemoMarkLanguage = .simplifiedChinese
    ) -> [MemoMarkiOSQueueDiagnosticEventProjection] {
        ...
        return events
            ...
            .compactMap { event in
                ...
                return MemoMarkiOSQueueDiagnosticEventProjection(
                    id: event.id,
                    timestamp:
                        event.timestamp,
                    title: title,
...
private extension MemoMarkiOSQueueDiagnosticsProjectionEngine {
