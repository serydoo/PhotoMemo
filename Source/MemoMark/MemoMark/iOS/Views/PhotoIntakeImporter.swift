...
// This adapter keeps type, local-identifier, and managed-file evidence
// together until the foreground request lifecycle accepts or discards it.
struct PickedPhotoFileRepresentation:
    Transferable {
    ...
    static var transferRepresentation:
        ...
        FileRepresentation(
            ...
            return PickedPhotoFileRepresentation(
                url: copiedURL
            )
        }
    }
