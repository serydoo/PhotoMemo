...
#if os(iOS)
struct WelcomePageSurface: View {
...
struct FirstRunConfigurationSheet: View {
...
struct WorkflowGuideSurface: View {

    let steps: [WelcomePresentation.WorkflowStep]
    let language: MemoMarkLanguage
    let onClose: (() -> Void)?
...
private struct WelcomeFeatureRow: View {
    ...
    let feature: WelcomePresentation.Feature
...
private struct WelcomeWorkflowPreviewRow: View {

    let step: WelcomePresentation.WorkflowStep
...
private struct WelcomeHeroMark: View {
