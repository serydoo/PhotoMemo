...
enum ConfigurationDeletionOutcome: Equatable {
    case deleted(ConfigurationLibraryDeletionResult)
    case rejected(message: String)
}

@MainActor
struct ConfigurationDeletionRuntimeCoordinator {
    ...
    ) async -> ConfigurationDeletionOutcome {
        await delete(
            preset,
...
private extension ConfigurationDeletionRuntimeCoordinator {
