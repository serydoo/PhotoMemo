...
struct V1SettingsPageSurface: View {
    ...
    private var settingsInsetBackground: some View {
        // Disclosure sections already provide the grouping boundary. Keep
        // their rows on the page background so Settings reads like a system
        // list instead of a stack of nested cards.
        Color.clear
    }
