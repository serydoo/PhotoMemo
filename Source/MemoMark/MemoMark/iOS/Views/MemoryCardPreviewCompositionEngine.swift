...
struct MemoryCardPreviewCompositionContext: Hashable {
    ...
    init(
        ...
        birthdayDate: Date,
        captureDate: Date = MemoryCardPreviewCompositionEngine.defaultCaptureDate,
...
struct MemoryCardPreviewDraft: Hashable {

    var items: [MemoryCardPreviewDraftItem]
...
struct MemoryCardPreviewRenderModel: Hashable {
...
struct MemoryCardPreviewDraftItem:
    Identifiable,
    Hashable {
...
private extension MemoryCardPreviewDraftItem.Kind {
...
typealias MemoryCardPreviewCompositionModule = MemoryCardModuleID

struct MemoryCardPreviewCompositionEngine {
    ...
    func displayText(
        for item: MemoryCardPreviewDraftItem,
        context: MemoryCardPreviewCompositionContext
    ) -> String {
    ...
    func displayText(
        for module: MemoryCardPreviewCompositionModule,
        context: MemoryCardPreviewCompositionContext
    ) -> String {
    ...
    func makeModuleItem(
        _ module: MemoryCardPreviewCompositionModule,
        context: MemoryCardPreviewCompositionContext
    ) -> MemoryCardPreviewDraftItem {
    ...
    private func previewMetadataContext(
        _ context: MemoryCardPreviewCompositionContext
    ) -> MetadataContext {
