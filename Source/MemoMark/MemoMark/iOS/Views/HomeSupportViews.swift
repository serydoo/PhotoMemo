...
enum HomeActivityState: Equatable {
...
struct HomeActivityProjection: Equatable {

    let jobID: UUID

    let state: HomeActivityState
...
struct HomeActivityPresentationState {
...
struct HomeRecentProcessingPresentation:
    Equatable {
...
enum HomeRecentProcessingPresenter {
    ...
    static func presentation(
        ...
        language: MemoMarkLanguage = .interfaceStored
    ) -> HomeRecentProcessingPresentation {
...
private extension HomeRecentProcessingPresenter {
...
struct HomeQuickActionsContent: View {
    ...
    private var actionButtons: some View {
        LazyVGrid(
            ...
            ForEach(
                HomeQuickAction.defaultActions(
                    language: language
                )
            ) { action in
                HomeActionTileButton(
                    title: action.title,
    ...
    private func perform(
        _ destination: HomeQuickAction.Destination
    ) {
        switch destination {
        case .processPhotos:
            openPhotoPicker()
...
struct HomeRecentProcessingContent: View {
