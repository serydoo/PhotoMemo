...
struct HomeSubjectSummaryProjection: Equatable {
    let title: String
    let subtitle: String
    let anchorTitle: String
}

struct HomeOutputSummaryProjection: Equatable {
    let title: String
    let detail: String
...
struct HomePresetSummaryProjection: Equatable {
    let title: String
    let subtitle: String
    let detail: String
...
enum HomeProjection {
    ...
    static func subjectSummary(
        ...
        return HomeSubjectSummaryProjection(
            title: title,
            subtitle: subtitle,
    ...
    static func presetSummary(
        ...
        isApplied: Bool,
        language: MemoMarkLanguage = .interfaceStored
    ) -> HomePresetSummaryProjection {

        return HomePresetSummaryProjection(
            title:
    ...
    private static func localizedOutputTargetNote(
        _ outputTarget: ConfigurationOutputTarget,
        language: MemoMarkLanguage
    ) -> String {
        language.localized(
