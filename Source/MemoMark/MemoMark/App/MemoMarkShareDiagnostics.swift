...
struct MemoMarkShareDiagnosticStage:
    RawRepresentable,
    Hashable,
    Codable,
    Sendable {
...
struct MemoMarkShareDiagnosticEvent:
    Identifiable,
    Codable,
    Hashable {
...
enum MemoMarkShareDiagnostics {
    ...
    nonisolated static func resetResult(
        ...
        defaults: UserDefaults =
            ...
            .sharedUserDefaults,
        encode:
            ([MemoMarkShareDiagnosticEvent]) throws
            -> Data = {
    ...
    > {
        ...
        do {
            let events =
                try JSONDecoder()
                .decode(
                    [MemoMarkShareDiagnosticEvent].self,
                    from: data
                )
    ...
    nonisolated static func persistResult(
        _ events: [MemoMarkShareDiagnosticEvent],
        defaults: UserDefaults =
            MemoMarkSharedContainer
            .sharedUserDefaults,
        encode:
...
enum MemoMarkShareProviderTypeSelection {
...
enum MemoMarkShareLivePhotoRepresentationProbe {
...
extension MemoMarkShareDiagnosticEvent {
