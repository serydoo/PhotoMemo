...
struct MemoMarkShareWorkflowSummary: Hashable {
...
struct MemoMarkShareWorkflowSummaryBuilder {
    ...
    func build(
        ...
        return MemoMarkShareWorkflowSummary(
            styleTitle:
...
private extension MemoMarkShareWorkflowSummaryBuilder {
