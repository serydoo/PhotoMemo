...
enum MemoMarkDesignTokens {
    ...
    enum Layout {
        ...
        static let compactActionClusterMaxWidth: CGFloat = 328
        static let compactActionClusterCornerRadius: CGFloat = 24
        static let compactActionClusterHorizontalPadding: CGFloat = 8
        static let compactActionClusterVerticalPadding: CGFloat = 5
    }
    ...
    enum Share {
        ...
        static let summaryValueRowMinimumHeight: CGFloat = 36
        static let summaryValueRowOpticalBottomInset: CGFloat = 4
