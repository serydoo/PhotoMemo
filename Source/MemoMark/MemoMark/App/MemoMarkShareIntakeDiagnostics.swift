...
struct MemoMarkMediaIntakeRejectionReport:
    Codable,
    Hashable {
...
enum MemoMarkShareIntakeFailureStage:
    String,
    Codable,
    Hashable {
...
enum MemoMarkShareIntakeDiagnosticError {
...
struct MemoMarkShareIntakeNSErrorSummary:
    Codable,
    Hashable {
...
struct MemoMarkShareIntakeFailureContext:
    Codable,
    Hashable {
...
struct MemoMarkShareIntakeOperationSeed:
    Codable,
    Hashable {
...
struct MemoMarkShareIntakeManagedCopyResult {
...
struct MemoMarkShareIntakePersistResult {
