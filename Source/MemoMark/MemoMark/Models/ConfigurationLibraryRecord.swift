        ...
        for subjectIndex in repaired.subjects.indices {
            for configurationIndex in
                ...
                repaired.subjects[subjectIndex]
                    ...
                    .editor.templatesByPresentationStyle =
                    repaired.subjects[subjectIndex]
                        .configurations[configurationIndex]
                        .editor.templatesByPresentationStyle
                        .mapValues {
                            $0.repairingDuplicateItemIDs()
                        }
                var editor = repaired.subjects[subjectIndex]
                    .configurations[configurationIndex].editor
                editor.template = editor.template(
                    for: repaired.subjects[subjectIndex]
                        .configurations[configurationIndex]
                        .presentation.route
                ).repairingDuplicateItemIDs()
                repaired.subjects[subjectIndex]
                    .configurations[configurationIndex]
                    .editor = editor
            }
